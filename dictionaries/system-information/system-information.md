# System Information — AppleScript Reference
...
> System Profiler specific classes.
...
- `basic` — A version which includes the basic hardware, software and network information. Moderate in size.
- `full` — A profile which includes all available information - can be quite large
- `mini` — A compact profile which does not include any personal identifying information

## Type Definitions

> Records used in scripting System Information
