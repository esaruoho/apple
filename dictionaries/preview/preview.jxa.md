# Preview — JavaScript for Automation (JXA) Reference

> Rendered from `preview.yaml` by `bin/sdef-to-jxa.py`. JXA dialect of the AppleScript dictionary in `preview.md`.
...
Preview.includeStandardAdditions = true   // if calling beep/say/displayDialog
```
...
```javascript
// Close an object.
Preview.close(target, {saving: /* savo */, savingIn: /* alias */})

// Return the number of elements of a particular class within an object.
Preview.count(target, {each: /* type */})

// Delete an object.
Preview.delete(target)

// Copy object(s) and put the copies at a new location.
Preview.duplicate(target, {to: Path('/path'), withProperties: {}})

// Verify if an object exists.
Preview.exists(target)

// Get the data for an object.
Preview.get(target)

// Make a new object.
Preview.make({new: /* type */, at: Path('/path'), withData: /* any */, withProperties: {}})

// Move object(s) to a new location.
Preview.move(target, {to: Path('/path')})

// Open an object.
Preview.open(/* alias */)

// Print an object.
Preview.print(/* alias */, {printDialog: true, withProperties: /* print settings */})

// Quit an application.
Preview.quit({saving: /* savo */})

// Save an object.
Preview.save(target, {as: '...', in: /* alias */})

// Set an object's data.
Preview.set(target, {to: /* any */})
...
_Records used in scripting Preview_
