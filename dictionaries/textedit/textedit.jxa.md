# Textedit — JavaScript for Automation (JXA) Reference

> Rendered from `textedit.yaml` by `bin/sdef-to-jxa.py`. JXA dialect of the AppleScript dictionary in `textedit.md`.
...
Textedit.includeStandardAdditions = true   // if calling beep/say/displayDialog
```

**Commands:** 13  ·  **Classes:** 12  ·  **Suites:** 5
...
```javascript
// Close an object.
Textedit.close(target, {saving: /* savo */, savingIn: /* alias */})

// Return the number of elements of a particular class within an object.
Textedit.count(target, {each: /* type */})

// Delete an object.
Textedit.delete(target)

// Copy object(s) and put the copies at a new location.
Textedit.duplicate(target, {to: Path('/path'), withProperties: {}})

// Verify if an object exists.
Textedit.exists(target)

// Get the data for an object.
Textedit.get(target)

// Make a new object.
Textedit.make({new: /* type */, at: Path('/path'), withData: /* any */, withProperties: {}})

// Move object(s) to a new location.
Textedit.move(target, {to: Path('/path')})

// Open an object.
Textedit.open(/* alias */)

// Print an object.
Textedit.print(/* alias */, {printDialog: true, withProperties: /* print settings */})

// Quit an application.
Textedit.quit({saving: /* savo */})

// Save an object.
Textedit.save(target, {as: '...', in: /* alias */})

// Set an object's data.
Textedit.set(target, {to: /* any */})
...
## Suite — TextEdit suite

_TextEdit specific classes._

## Suite — Type Definitions

_Records used in scripting TextEdit_
