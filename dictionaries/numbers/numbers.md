...
> Classes and commands for Numbers.
...
- **Direct parameter**: `range` — 
- **Returns**: `specifier` — A reference to the new column
...
- **Direct parameter**: `range` — 
- **Returns**: `specifier` — A reference to the new row
