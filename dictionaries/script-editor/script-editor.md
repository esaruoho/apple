# Script Editor — AppleScript Reference
...
> Classes and Commands for working with the Script Editor
...
- **Direct parameter**: `specifier` — the object for the command
- **as**: `text` *(optional)* — The file type in which to save the data. Use one of the following strings: "script", "script bundle", "application", "text".
- **in**: `alias` *(optional)* — The file in which to save the object.
- **run only**: `boolean` *(optional)* — Should the script be saved as Run-Only? If it is, you will not be able to edit the contents of the script again. The default is not to save as run only. (Applies to all script types except for "text").
- **startup screen**: `boolean` *(optional)* — Show the startup screen? The default is not to show the startup screen. (Only applies to scripts saved as "application").
- **stay open**: `boolean` *(optional)* — Should the application remain open after it is launched? The default is not to stay open. (Only applies to scripts saved as "application").
...
| Property | Type | Access | Description |
|----------|------|--------|-------------|
| `contents` | `item` | rw | The contents of the insertion point. |
...
| Property | Type | Access | Description |
|----------|------|--------|-------------|
| `description` | `text` | r | The description |
| `id` | `text` | r | The unique id of the language. |
| `name` | `text` | r | The name of the language. |
| `supports compiling` | `boolean` | r | Is the language compilable? |
| `supports recording` | `boolean` | r | Is the language recordable? |
...
| Property | Type | Access | Description |
|----------|------|--------|-------------|
| `character range` | `point` | r | The range of characters in the selection. |
| `contents` | `item` | rw | The contents of the selection. |

## Type Definitions

> Records used in scripting Script Editor
