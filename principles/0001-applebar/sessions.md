...
> The folder `apple-bar` may be modified by several sessions at once (fm-converse,
...
## How to get back
<Run `convey bundle 0001-applebar --transcript <path-to.jsonl>` to copy the spawning
