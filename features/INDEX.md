...
```
Capture one application's audio to a .wav without a loopback driver  —  12 scenarios   (features/app-audio-record.feature)
  ...
  honesty: 12/12 scenario(s) claim working but have no Convey runner — unverified by Convey (declared grades trusted)
