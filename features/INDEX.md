...
```
Read macOS energy & power telemetry from the command line  —  11 scenarios   (features/apple-energy.feature)
  ...
  honesty: 10/11 scenario(s) claim working but have no Convey runner — unverified by Convey (declared grades trusted)
