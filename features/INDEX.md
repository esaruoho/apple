...
The on-device agentic tool-calling loop on the Mini's MLX brain  —  6 scenarios   (features/mlx-agent-tool-loop.feature)
  ...
  - [@built @untested] a real task drives the belt end-to-end on the Mini
