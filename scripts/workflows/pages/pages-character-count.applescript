-- Show character count of front document
-- App: Pages
-- Triggers: character, count, show, front, document
-- Category: Pages
-- Usage: osascript scripts/workflows/pages/pages-character-count.applescript
