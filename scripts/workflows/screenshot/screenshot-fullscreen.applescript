-- Capture full screen to Desktop
-- App: Screenshot
-- Triggers: fullscreen, capture, full, screen, desktop
-- Category: Screenshot
-- Usage: osascript scripts/workflows/screenshot/screenshot-fullscreen.applescript
