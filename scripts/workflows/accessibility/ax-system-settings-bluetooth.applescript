-- Open System Settings Bluetooth pane via Accessibility API
-- Triggers: ax, system, settings, bluetooth, open, pane, accessibility, api
-- Category: Accessibility
-- Tier 8: Accessibility API — reaches apps with zero AppleScript support
-- Usage: osascript scripts/workflows/accessibility/ax-system-settings-bluetooth.applescript
...
tell application "System Events"
	tell process "System Settings"
		try
			click button "Bluetooth" of group 1 of scroll area 1 of group 1 of splitter group 1 of group 1 of window 1
		on error
