-- Open System Settings Displays pane via Accessibility API
-- Triggers: ax, system, settings, displays, open, pane, accessibility, api
-- Category: Accessibility
-- Tier 8: Accessibility API — reaches apps with zero AppleScript support
-- Usage: osascript scripts/workflows/accessibility/ax-system-settings-displays.applescript
...
tell application "System Events"
	tell process "System Settings"
		try
			click button "Displays" of group 1 of scroll area 1 of group 1 of splitter group 1 of group 1 of window 1
		on error
