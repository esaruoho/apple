-- Get mute
-- App: Music
-- Usage: osascript scripts/auto-workflows/music/music-get-mute.applescript
...
tell application "Music"
    set val to mute as text
    display dialog "mute: " & val with title "Music" buttons {"OK"} default button "OK"
end tell
