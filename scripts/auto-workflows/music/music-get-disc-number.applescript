...
-- App: Music
-- Usage: osascript scripts/auto-workflows/music/music-get-disc-number.applescript
...
tell application "Music"
    set val to disc number of current track as text
    display dialog "disc number: " & val with title "Music" buttons {"OK"} default button "OK"
end tell
