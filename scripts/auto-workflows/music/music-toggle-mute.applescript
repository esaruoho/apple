-- Toggle mute
-- App: Music
-- Usage: osascript scripts/auto-workflows/music/music-toggle-mute.applescript
...
tell application "Music"
    ...
    if mute then
        display notification "mute: ON" with title "Music"
    else
        display notification "mute: OFF" with title "Music"
    end if
end tell
