...
-- App: Music
-- Usage: osascript scripts/auto-workflows/music/music-get-track-number.applescript
...
tell application "Music"
    set val to track number of current track as text
    display dialog "track number: " & val with title "Music" buttons {"OK"} default button "OK"
end tell
