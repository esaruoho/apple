...
-- App: Music
-- Usage: osascript scripts/auto-workflows/music/music-get-album.applescript
...
tell application "Music"
    set val to album of current track
    display dialog "album: " & val with title "Music" buttons {"OK"} default button "OK"
end tell
