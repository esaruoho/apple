...
-- App: Music
-- Usage: osascript scripts/auto-workflows/music/music-get-played-count.applescript
...
tell application "Music"
    set val to played count of current track as text
    display dialog "played count: " & val with title "Music" buttons {"OK"} default button "OK"
end tell
