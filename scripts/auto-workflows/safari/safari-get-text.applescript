...
-- App: Safari
-- Usage: osascript scripts/auto-workflows/safari/safari-get-text.applescript
...
tell application "Safari"
    set val to text of current tab of front window
    display dialog "text: " & val with title "Safari" buttons {"OK"} default button "OK"
end tell
