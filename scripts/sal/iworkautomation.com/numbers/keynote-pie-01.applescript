property useTableNameForSlideTitle : false
			...
			if rowCount is greater than columnCount then
				...
				tell application "Keynote"
					...
					tell the front document
						...
						tell thisSlide
							if useTableNameForSlideTitle is true then
								set slideTitle to thisTableName
							else
								set slideTitle to (item 1 of the columnNames)
							end if
					...
					tell the front document
						...
						tell thisSlide
							if useTableNameForSlideTitle is true then
								...
								set slideTitle to (item 1 of the rowNames)
							end if
							set the object text of the default title item to slideTitle
