property defaultMovieWidth : 360
...
tell application "Pages"
	...
	try
		...
		tell document 1
			-- IMPORT MOVIE FILE TO CURRENT PAGE
			tell the current page
				-- Pages does not support using the movie class with the make verb
